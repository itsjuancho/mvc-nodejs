...
router.get('/listar', (req, res, next) =>{
    try {
        ...
        bd.query('SELECT * FROM users', function (error,data){
...
router.post('/store', (req, res, next) =>{
  console.log(req.body);
    ...
    try {
        bd.query('insert into users(usuario,clave) values(?,?)',registro, function (error,data){
          bd.query('SELECT * FROM users', function (error,data){
                res.render('users/listar',{users: data});
            });
        });
...
router.get('/edit/:id', (req, res, next) =>{
    console.log("entre");
      try {
          bd.query('SELECT * FROM users where id='+req.params.id, function (error,data){
  ...
  router.get('/eliminar/:id', (req, res, next) =>{
    ...
    router.post('/update', (req, res, next) =>{
        ...
        try {
            ...
            bd.query(sql,parametros, function (error,data){
                  bd.query('SELECT * FROM users', function (error,data){
                      res.render('users/listar',{users: data});
                  });
            }); 
    ...
    router.post('/delete', (req, res, next) =>{
          ...
          try {
              bd.query('delete FROM users where id='+req.body.id, function (error,data){
                  bd.query('SELECT * FROM users', function (error,data){
                      res.render('users/listar',{users: data});
                  });
              });
